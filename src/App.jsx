    ...
    <section id="for-dealers" style={{ background:"#edeae4", padding:"7rem 1.5rem" }}>
      <div style={{ maxWidth:"64rem", margin:"0 auto" }}>
        ...
        <div className="reveal" style={{ borderRadius:"1.5rem", overflow:"hidden", height:280, marginBottom:"4rem", position:"relative", border:"1px solid rgba(26,24,20,0.10)", boxShadow:"0 12px 40px rgba(26,24,20,0.14)" }}>
          <img src="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=1200&q=80" alt="Dealer lot" style={{ width:"100%", height:"100%", objectFit:"cover", objectPosition:"center 40%" }} loading="lazy" />
          <div style={{ position:"absolute", inset:0, background:"linear-gradient(to right, rgba(26,24,20,0.65) 0%, rgba(26,24,20,0.15) 60%, transparent 100%)" }} />
